...
public class TimePickerDialogCustom extends TimePickerDialog {
     ...
     */
    public TimePickerDialogCustom(Context context, OnTimeSetListener listener, int hourOfDay, int minute, boolean is24HourView) {
     ...
     * @param is24HourView Whether this is a 24 hour view, or AM/PM.
     */
    public TimePickerDialogCustom(Context context, int themeResId, OnTimeSetListener listener, int hourOfDay, int minute, boolean is24HourView) {
    ...
    private void fixSpinner(Context context, int hourOfDay, int minute, boolean is24HourView) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) { // android:timePickerMode spinner and clock began in Lollipop
            try {
                ...
                //set to dua(2) to change to spinner style
